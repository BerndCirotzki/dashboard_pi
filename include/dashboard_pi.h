...
public:
  DashboardWindowContainer(DashboardWindow *dashboard_window,
                           ...
                           wxArrayInt inst, wxSize Size, wxPoint Position, long Style,
...
private:
  ...
  wxDateTime engineWatchDogDynamic;
...
class DashboardWindow : public wxDialog {
public:
