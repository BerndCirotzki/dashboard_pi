...
class DashboardInstrument_SpeedometerSOGSTW : public DashboardInstrument_Dial {
public:
    DashboardInstrument_SpeedometerSOGSTW(wxWindow* parent, wxWindowID id,
        wxString title, InstrumentProperties* Properties, DASH_CAP cap_flag,
        int s_value, int e_value);

    ~DashboardInstrument_SpeedometerSOGSTW(void) {}
    void SetData(DASH_CAP, double, wxString);
private:
protected:
    double m_MainValueApp, m_MainValueTrue;
    double m_ExtraValueApp, m_ExtraValueTrue, LastValue;

    wxString m_MainValueAppUnit, m_MainValueTrueUnit;    
